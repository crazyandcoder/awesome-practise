...
def insert_mysql(id):
    ...
    url = "https://api.eol.cn/gkcx/api/?access_token=&keyword=&page=" + str(
        id) + "&request_type=1&signsafe=&size=20&sort=view_total&uri=apidata/api/gk/special/lists"
    ...
    for i in range(length):
        ...
        try:
            ...
            sql = "insert into top_university_school_profession_list_hot(degree,profession_id,level1,level2,level3,level1_name," \
                  "level2_name,level3_name,limit_year,name,rankall,spcode,special_id ,view_month,view_total,view_week)values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
