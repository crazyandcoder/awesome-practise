...
/**
 * @ClassName: NormalItemView
 * @Description: java类作用描述
 * @Author: crazyandcoder
 * @email: lijiwork@sina.com
 * @CreateDate: 2020/5/26 5:33 PM
 * @UpdateUser: 更新者
 * @UpdateDate: 2020/5/26 5:33 PM
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
...
public class NormalItemView extends AbsBaseTabItem {
    ...
    public NormalItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(R.layout.common_item_normal, this, true);
