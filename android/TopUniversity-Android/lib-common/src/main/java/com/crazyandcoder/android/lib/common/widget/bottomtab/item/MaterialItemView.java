...
/**
 * @ClassName: MaterialItemView
 * @Description: java类作用描述
 * @Author: crazyandcoder
 * @email: lijiwork@sina.com
 * @CreateDate: 2020/5/26 5:21 PM
 * @UpdateUser: 更新者
 * @UpdateDate: 2020/5/26 5:21 PM
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
 ...
 * 材料设计风格项
 */
public class MaterialItemView extends AbsBaseTabItem {
    ...
    public MaterialItemView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(R.layout.common_item_material, this, true);
