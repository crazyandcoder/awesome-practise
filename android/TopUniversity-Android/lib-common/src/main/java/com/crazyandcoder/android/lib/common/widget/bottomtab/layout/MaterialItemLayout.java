package com.crazyandcoder.android.lib.common.widget.bottomtab.layout;

/**
 * @ClassName: MaterialItemLayout
 * @Description: java类作用描述
 * @Author: crazyandcoder
 * @email: lijiwork@sina.com
 * @CreateDate: 2020/5/26 5:20 PM
 * @UpdateUser: 更新者
 * @UpdateDate: 2020/5/26 5:20 PM
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
...
public class MaterialItemLayout extends ViewGroup implements ItemController {
    ...
    public MaterialItemLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        MATERIAL_BOTTOM_NAVIGATION_ACTIVE_ITEM_MAX_WIDTH = res.getDimensionPixelSize(R.dimen.common_material_bottom_navigation_active_item_max_width);
        MATERIAL_BOTTOM_NAVIGATION_ITEM_MAX_WIDTH = res.getDimensionPixelSize(R.dimen.common_material_bottom_navigation_item_max_width);
        MATERIAL_BOTTOM_NAVIGATION_ITEM_MIN_WIDTH = res.getDimensionPixelSize(R.dimen.common_material_bottom_navigation_item_min_width);
        MATERIAL_BOTTOM_NAVIGATION_ITEM_HEIGHT = res.getDimensionPixelSize(R.dimen.common_material_bottom_navigation_height);
        ...
        if ((mode & MaterialMode.CHANGE_BACKGROUND_COLOR) > 0) {
            ...
            for (int i = 0; i < mItems.size(); i++) {
                ...
                if (Build.VERSION.SDK_INT >= 21) {
                    ...
                    v.setBackgroundResource(R.drawable.common_material_item_background);
                }
            }
        }
    ...
    @Override
    public void addCustomItem(int index, AbsBaseTabItem item) {
        // nothing
    }
