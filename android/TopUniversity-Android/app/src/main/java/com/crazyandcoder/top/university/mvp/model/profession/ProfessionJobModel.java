 ...
 */
@ActivityScope
public class ProfessionJobModel extends CrazyBaseModel implements ProfessionJobContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public ProfessionJobModel(IRepositoryManager repositoryManager) {
